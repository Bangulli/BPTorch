...
class BigPictureRepository(tc.utils.data.Dataset):
    ...
    def __len__(self):
        ...
        elif self.prepatched_source is None and self.return_type=='patch': return len(self.patch_idx)
    ...
    def __getitem__(self, idx):
        if self.return_type=='wsi':
            ...
            if self.prepatched_source is None:
                ...
                img = self.to_tensor(Image.open(self.prepatched_source/self.patch_paths[idx]).convert('RGB')).to(tc.float)
